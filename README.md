...
## ✨ News:
- [2026-02-20] Our paper **"VideoFusion: A Spatio-Temporal Collaborative Network for Multi-modal Video Fusion"** has been accepted by **CVPR 2026** (the IEEE/CVF Conference on Computer Vision and Pattern Recognition).  [[Paper](https://arxiv.org/abs/2503.23359)] [[Code](https://github.com/Linfeng-Tang/VideoFusion)]
